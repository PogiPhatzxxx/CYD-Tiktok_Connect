...
import TikTokWsClient from 'tiktok-live-connector/src/lib/ws/lib/ws-client';
import { RoomGiftInfo, RoomInfo, TikTokLiveConnectionOptions } from 'tiktok-live-connector/src/types/client';
import { RoomInfoResponse, TikTokWebClient } from 'tiktok-live-connector/src/lib/web';
import { EulerSigner } from 'tiktok-live-connector/src/lib/web/lib/tiktok-signer';
import { ConnectState, EventMap, TikTokLiveConnectionState } from 'tiktok-live-connector/src/types/events';
import { IWebcastRoomChatPayload, IWebcastRoomChatRouteResponse } from '@eulerstream/euler-api-sdk';
declare const TikTokLiveConnection_base: new () => TypedEventEmitter<EventMap>;
export declare class TikTokLiveConnection extends TikTokLiveConnection_base {
     ...
     * @protected
     */
    protected setupWebsocket(wsUrl: string, wsParams: Record<string, string>): Promise<TikTokWsClient>;
    protected processWebcastResponse(webcastResponse: WebcastResponse): Promise<void>;
    /**
