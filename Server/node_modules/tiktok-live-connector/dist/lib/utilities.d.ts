...
/// <reference types="node" />
import { DecodedWebcastWebsocketMessage, IWebcastDeserializeConfig, WebcastMessage } from 'tiktok-live-connector/src/types/client';
import { DevicePreset } from 'tiktok-live-connector/src/lib/config';
...
export declare function deserializeWebSocketMessage(binaryMessage: Uint8Array): Promise<DecodedWebcastWebsocketMessage>;
