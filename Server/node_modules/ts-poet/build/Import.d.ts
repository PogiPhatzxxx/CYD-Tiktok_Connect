import { Node } from "ts-poet/build/Node";
...
export declare abstract class Import extends Node {
     ...
     */
    static importsName(exportedName: string, from: string, typeImport: boolean, sourceSymbol?: string, childSymbol?: string): Import;
    /**
...
export declare class ImportsName extends Imported {
     ...
     */
    constructor(symbol: string, source: string, sourceSymbol?: string | undefined, typeImport?: boolean | undefined, childSymbol?: string | undefined);
    toImportPiece(skipTypeImport?: boolean): string;
    toCodeString(): string;
}
/**
 * Imports a single named symbol from the module's exported
